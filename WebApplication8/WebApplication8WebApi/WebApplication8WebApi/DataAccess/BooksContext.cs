namespace WebApplication8WebApi.DataAccess
{
    using System;
    using System.Data.Entity;
    using System.Linq;
    using WebApplication8WebApi.Models;

    public class BooksContext : DbContext
    {
        // Your context has been configured to use a 'BooksContext' connection string from your application's 
        // configuration file (App.config or Web.config). By default, this connection string targets the 
        // 'WebApplication8WebApi.DataAccess.BooksContext' database on your LocalDb instance. 
        // 
